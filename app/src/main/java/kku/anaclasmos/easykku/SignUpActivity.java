...
public class SignUpActivity extends AppCompatActivity {
    ...
    private Uri uri;
    private boolean aBoonlean = true;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (nameString.equals("") || phoneString.equals("") || userString.equals("") || passwordString.equals("")) {
                    ...
                    //Non Choose Image
                    MyAlert myAlert = new MyAlert(SignUpActivity.this, R.drawable.nobita48, "ยังไม่เลือกรูป", "กรุณาเลือกรูปด้วยครับ");
                    myAlert.myDialog();
                }else{
                    //Choose Image Ok
                    upLoadImageToServer();
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivityForResult(Intent.createChooser(intent, "โปรเลือกโปรแกรมดูภาพ"),0);
    ...
    private class AddNewUser extends AsyncTask<String, Void, String> {
        ...
        }   //doInBack ททำงานอยุ่เบื้องหลัง ำหน้าที่ต่อเน็ต
        ...
        protected void onPostExecute(String s) {
            ...
            if(Boolean.parseBoolean(s)){
                Toast.makeText(context, "Uplolad Success",Toast.LENGTH_SHORT).show();
                finish();
            }else {
                Toast.makeText(context, "Cannot Uplolad Success",Toast.LENGTH_SHORT).show();

            }

        }   //OnPost ทำงานหลัง DoItBack ทำงานเสร็จ
    }   // AddNewUser class
